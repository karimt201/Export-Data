...
import controllers.DataWriter as writer
...
class TestCrudOperator(unittest.TestCase):
    ...
    def test_crud_operator(self):
        ...
        assert_that(crud_operator_obj.post_list(data)).is_equal_to([{'name':'karim'},{'name':'omar'}])
...
class TestDatabaseHandler(unittest.TestCase):
    def test_data_handler(self):
        ...
        assert_that(str(post_all_data_types_exc.exception)).is_equal_to('invalid input, only accept dict data or list of dicts')
...
class TestSerializer(unittest.TestCase):
    ...
    def test_serializer(self):
        ...
        serializer_test = sr._DataSerializer(serializer_double,"success")._All_serialize()
...
class TestError(unittest.TestCase):
    ...
    def test_write_raise_exception(self):
        ...
        assert_that(str(exc.exception)).is_equal_to('children must implement this method')

class TestExcelCreator(unittest.TestCase):

    def test_write(self):
        workbook = WorkBookDouble()
        creator = excel.ExcelCreator(workbook)
...
class TestCSVCreator(unittest.TestCase):
        ...
        def test_sava_csv(self):
            ...
            creator = csv.CSVCreator(writer_double)
            data = ExcelDataDouble(headers=['name', 'age'], rows=[['test', 20]])
...
class TestPdfCreator(unittest.TestCase):
    ...
    def test_write(self):
        ...
        creator = pdf.PDFCreator(pdf_writer)
        data = ExcelDataDouble(headers=['name', 'age'], rows=[['test', 20]])
